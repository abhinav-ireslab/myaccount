...
public class TestBaseNew {
		...
		try {
			...
			try {
				FileInputStream ip = new FileInputStream(
						"C:\\Users\\E2E\\git\\New folder\\testing\\src\\main\\java\\MyAccount\\com\\Config\\config.properties");
				prop.load(ip);
	...
	public static void inititalization() {
		...
		// }
			 ...
			 * ; driver = (WebDriver) new FirefoxDriver();
			 * //System.out.println("Launch Firefox"); }else if
			 * (browserName.equals("chrome")){ System.setProperty("webdriver.chrome.driver",
			 * "C:\\Users\\E2E\\eclipse-workspace\\AutomationE2E\\Drivers\\chromedrive.exe")
